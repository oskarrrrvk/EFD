...
package asm_generic_posix_types_h is
  ...
  --  
   ...
   subtype uu_kernel_old_dev_t is unsigned;  -- /usr/include/asm-generic/posix_types.h:59
  ...
  --  
   ...
   type anon_array1480 is array (0 .. 1) of aliased int;
   type uu_kernel_fsid_t is record
      val : aliased anon_array1480;  -- /usr/include/asm-generic/posix_types.h:80
   end record

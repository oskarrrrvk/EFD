...
package aarch64_linux_gnu_bits_types_u_mbstate_t_h is
  ...
  -- Value so far.   
   subtype anon_array1513 is Interfaces.C.char_array (0 .. 3);
   type anon_union1511 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_wch : aliased unsigned;  -- /usr/include/aarch64-linux-gnu/bits/types/__mbstate_t.h:18
         when others =>
            uu_wchb : aliased anon_array1513;  -- /usr/include/aarch64-linux-gnu/bits/types/__mbstate_t.h:19
      end case;
   end record
   ...
   type uu_mbstate_t is record
      ...
      uu_value : aliased anon_union1511;  -- /usr/include/aarch64-linux-gnu/bits/types/__mbstate_t.h:20
   end record

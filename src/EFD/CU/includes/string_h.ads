...
package string_h is
  ...
  -- Compare the collated forms of S1 and S2, using sorting rules from L.   
   function strcoll_l
     (uu_s1 : Interfaces.C.Strings.chars_ptr;
      uu_s2 : Interfaces.C.Strings.chars_ptr;
      uu_l : aarch64_linux_gnu_bits_types_locale_t_h.locale_t) return int  -- /usr/include/string.h:175
   with Import => True, 
        Convention => C, 
  ...
  --   using sorting rules from L.   
   ...
   function strxfrm_l
     (uu_dest : Interfaces.C.Strings.chars_ptr;
      ...
      uu_l : aarch64_linux_gnu_bits_types_locale_t_h.locale_t) return stddef_h.size_t  -- /usr/include/string.h:179
   with Import => True, 
        Convention => C, 
  ...
  -- Translate error number to string according to the locale L.   
   function strerror_l (uu_errnum : int; uu_l : aarch64_linux_gnu_bits_types_locale_t_h.locale_t) return Interfaces.C.Strings.chars_ptr  -- /usr/include/string.h:458
   with Import => True, 
        Convention => C, 

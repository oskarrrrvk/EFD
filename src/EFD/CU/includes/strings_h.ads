...
package strings_h is
  ...
  -- Compare S1 and S2, ignoring case, using collation rules from LOC.   
   function strcasecmp_l
     (uu_s1 : Interfaces.C.Strings.chars_ptr;
      uu_s2 : Interfaces.C.Strings.chars_ptr;
      uu_loc : aarch64_linux_gnu_bits_types_locale_t_h.locale_t) return int  -- /usr/include/strings.h:128
   with Import => True, 
        Convention => C, 
  ...
  --   collation rules from LOC.   
   ...
   function strncasecmp_l
     (uu_s1 : Interfaces.C.Strings.chars_ptr;
      ...
      uu_loc : aarch64_linux_gnu_bits_types_locale_t_h.locale_t) return int  -- /usr/include/strings.h:133
   with Import => True, 
        Convention => C, 

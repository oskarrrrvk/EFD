...
package aarch64_linux_gnu_bits_types_struct_FILE_h is
  ...
  -- High-order word is _IO_MAGIC; rest is flags.  
   type u_IO_FILE;
   subtype anon_array1529 is Interfaces.C.char_array (0 .. 0);
   subtype anon_array1534 is Interfaces.C.char_array (0 .. 19);
   type u_IO_FILE is record
      ...
      u_shortbuf : aliased anon_array1529;  -- /usr/include/aarch64-linux-gnu/bits/types/struct_FILE.h:79
      ...
      u_unused2 : aliased anon_array1534;  -- /usr/include/aarch64-linux-gnu/bits/types/struct_FILE.h:98
   end record

...
package aarch64_linux_gnu_sys_select_h is
  ...
  -- Get definition of timer specification structures.   
   subtype suseconds_t is aarch64_linux_gnu_bits_types_h.uu_suseconds_t;  -- /usr/include/aarch64-linux-gnu/sys/select.h:43
  ...
  --       from the global namespace.   
   ...
   type anon_array1859 is array (0 .. 15) of aliased uu_fd_mask;
   type fd_set is record
      uu_fds_bits : aliased anon_array1859;  -- /usr/include/aarch64-linux-gnu/sys/select.h:67
   end record

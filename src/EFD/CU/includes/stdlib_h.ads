...
package stdlib_h is
  ...
  -- Current state.   
   type anon_array1959 is array (0 .. 2) of aliased unsigned_short;
   type drand48_data is record
      uu_x : aliased anon_array1959;  -- /usr/include/stdlib.h:493
      uu_old_x : aliased anon_array1959;  -- /usr/include/stdlib.h:494
  ...
  -- Return a random integer between zero and 2**32-1 (inclusive).   
   function arc4random return aarch64_linux_gnu_bits_types_h.uu_uint32_t  -- /usr/include/stdlib.h:538
   with Import => True, 
        Convention => C, 
        External_Name => "arc4random";

  -- Fill the buffer with random data.   
   procedure arc4random_buf (uu_buf : System.Address; uu_size : stddef_h.size_t)  -- /usr/include/stdlib.h:542
   with Import => True, 
        Convention => C, 
  ...
  --   limit (exclusive).   
   ...
   function arc4random_uniform (uu_upper_bound : aarch64_linux_gnu_bits_types_h.uu_uint32_t) return aarch64_linux_gnu_bits_types_h.uu_uint32_t  -- /usr/include/stdlib.h:547
   with Import => True, 
        Convention => C, 
        External_Name => "arc4random_uniform";

  -- Allocate SIZE bytes of memory.   
   function malloc (uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:553
   with Import => True, 
        Convention => C, 
        External_Name => "malloc";

  -- Allocate NMEMB elements of SIZE bytes each, all initialized to 0.   
   function calloc (uu_nmemb : stddef_h.size_t; uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:556
   with Import => True, 
        Convention => C, 
  ...
  --   between objects pointed by the old and new pointers.   
   ...
   function realloc (uu_ptr : System.Address; uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:564
   with Import => True, 
        Convention => C, 
  ...
  -- Add reallocarray as its own deallocator.   
   function reallocarray
     (uu_ptr : System.Address;
      ...
      uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:582
   with Import => True, 
        Convention => C, 
        External_Name => "reallocarray";

  -- Allocate SIZE bytes on a page boundary.  The storage cannot be freed.   
   function valloc (uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:593
   with Import => True, 
        Convention => C, 
  ...
  -- Allocate memory of SIZE bytes with an alignment of ALIGNMENT.   
   function posix_memalign
     (uu_memptr : System.Address;
      ...
      uu_size : stddef_h.size_t) return int  -- /usr/include/stdlib.h:599
   with Import => True, 
        Convention => C, 
        External_Name => "posix_memalign";

  -- ISO C variant of aligned allocation.   
   function aligned_alloc (uu_alignment : stddef_h.size_t; uu_size : stddef_h.size_t) return System.Address  -- /usr/include/stdlib.h:605
   with Import => True, 
        Convention => C, 
  ...
  --   buffers.   
   ...
   function ecvt_r
     (uu_value : double;
      ...
      uu_len : stddef_h.size_t) return int  -- /usr/include/stdlib.h:923
   with Import => True, 
        Convention => C, 
   ...
   function fcvt_r
     (uu_value : double;
      ...
      uu_sign : access int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_len : stddef_h.size_t) return int  -- /usr/include/stdlib.h:926
   with Import => True, 
        Convention => C, 
   ...
   function qecvt_r
     (uu_value : long_double;
      ...
      uu_sign : access int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_len : stddef_h.size_t) return int  -- /usr/include/stdlib.h:930
   with Import => True, 
        Convention => C, 
   ...
   function qfcvt_r
     (uu_value : long_double;
      ...
      uu_sign : access int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_len : stddef_h.size_t) return int  -- /usr/include/stdlib.h:934
   with Import => True, 
        Convention => C, 
  ...
  --   in S, which is no longer than N.   
   ...
   function mblen (uu_s : Interfaces.C.Strings.chars_ptr; uu_n : stddef_h.size_t) return int  -- /usr/include/stdlib.h:943
   with Import => True, 
        Convention => C, 
        External_Name => "mblen";
  ...
  --   putting its `wchar_t' representation in *PWC.   
   ...
   function mbtowc
     (uu_pwc : access stddef_h.wchar_t;
      ...
      uu_n : stddef_h.size_t) return int  -- /usr/include/stdlib.h:946
   with Import => True, 
        Convention => C, 
  ...
  --   by WCHAR in S, returning its length.   
   ...
   function wctomb (uu_s : Interfaces.C.Strings.chars_ptr; uu_wchar : stddef_h.wchar_t) return int  -- /usr/include/stdlib.h:950
   with Import => True, 
        Convention => C, 
  ...
  -- Convert a multibyte string to a wide char string.   
   function mbstowcs
     (uu_pwcs : access stddef_h.wchar_t;
      uu_s : Interfaces.C.Strings.chars_ptr;
      uu_n : stddef_h.size_t) return stddef_h.size_t  -- /usr/include/stdlib.h:954
   with Import => True, 
        Convention => C, 
  ...
  -- Convert a wide char string to multibyte string.   
   function wcstombs
     (uu_s : Interfaces.C.Strings.chars_ptr;
      uu_pwcs : access stddef_h.wchar_t;
      uu_n : stddef_h.size_t) return stddef_h.size_t  -- /usr/include/stdlib.h:958
   with Import => True, 
        Convention => C, 

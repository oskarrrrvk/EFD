  ...
  --   result in buffer of length LEN astarting at BUF.   
   ...
   function inet_ntop
     (uu_af : int;
      ...
      uu_len : unistd_h.socklen_t) return Interfaces.C.Strings.chars_ptr  -- /usr/include/arpa/inet.h:64
   with Import => True, 
        Convention => C, 
  ...
  --   the number.   
   ...
   function inet_net_ntop
     (uu_af : int;
      ...
      uu_bits : int;
      uu_buf : Interfaces.C.Strings.chars_ptr;
      uu_len : stddef_h.size_t) return Interfaces.C.Strings.chars_ptr  -- /usr/include/arpa/inet.h:83
   with Import => True, 
        Convention => C, 
  ...
  --   buffer starting at BUF of size LEN.   
   ...
   function inet_net_pton
     (uu_af : int;
      ...
      uu_len : stddef_h.size_t) return int  -- /usr/include/arpa/inet.h:89
   with Import => True, 
        Convention => C, 
